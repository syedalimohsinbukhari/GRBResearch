...
scipy.optimize.curve_fit does internally). Same 7-pulse COMPLEX P0, same dominant-flux LAT-photon
...
ax.set_title(f"{GRB_PAPER_NAME}: unnormalized (x_scale) fit (COMPLEX), full range {FIT_WINDOW[0]:.1f}-{FIT_WINDOW[1]:.1f}s")
