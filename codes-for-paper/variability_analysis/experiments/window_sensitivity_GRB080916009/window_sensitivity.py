...
# "n3+n4 summed" ROOT cross-check precedent (variability_analysis.md). This structurally closes BUG-23:
# there's no longer a single detector to mis-pick via os.listdir()[0]/sorted()[0]. Detector time grids are
