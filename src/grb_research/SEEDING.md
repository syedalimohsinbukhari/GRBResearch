...
- A mention of this seeding scheme (including the `MASTER_SEED` provenance above) belongs in
  the paper's methods section, in the sibling `GRBResearchPaper` repo. Not yet done — tracked
